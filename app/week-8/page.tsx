...
export default function LoginPage() {
    ...
    return(
        <main>
            ...
            <h1 className="text-center text-pink-700 font-bold mb-4">Sign in to Shopping List </h1>
                <br />
                {!user && (
            ...
            {user && (
                <>
                    <div className="text-center mb-4">
                        ...
                        <Link href="/week-8/shopping-list" className="text-pink-700 hover:underline">
